...
//@interface spfc_meObject : NSObject
//@end

@interface spfc_meObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[spfc_meObject class]])
		{
			for (NSString *key in [[(spfc_meObject*)o modules] allKeys])
			{
