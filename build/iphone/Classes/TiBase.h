...
// in simulator we redefine to format for spfc_me Developer console
...
{\
	NSString * exceptionName = [@"org.spfc_me." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.spfc_me";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIspfc_meNativeItemNone = -1, 
	UIspfc_meNativeItemSpinner = -2,
	UIspfc_meNativeItemProgressBar = -3,
	
	UIspfc_meNativeItemSlider = -4,
	UIspfc_meNativeItemSwitch = -5,
	UIspfc_meNativeItemMultiButton = -6,
	UIspfc_meNativeItemSegmented = -7,
	
	UIspfc_meNativeItemTextView = -8,
	UIspfc_meNativeItemTextField = -9,
	UIspfc_meNativeItemSearchBar = -10,
	
	UIspfc_meNativeItemPicker = -11,
	UIspfc_meNativeItemDatePicker = -12,
	
	UIspfc_meNativeItemInfoLight = -13,
	UIspfc_meNativeItemInfoDark = -14,
	
	UIspfc_meNativeItemDisclosure = -15,
	
	UIspfc_meNativeItemContactAdd = -16
};
